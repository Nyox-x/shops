...
from wtforms import StringField, PasswordField, SubmitField, TextAreaField  #导入字段类
from wtforms.validators import DataRequired, Email, Regexp, EqualTo, ValidationError,Length #导入验证器
...
class RegisterForm(FlaskForm):
    ...
    phone = StringField(
        ...
        validators=[
            ...
            Regexp("1[34578][0-9]{9}", message="手机号码格式不正确") #正则，1，9位数
        ],
        description="手机号",
        render_kw={
            "type": "text",
